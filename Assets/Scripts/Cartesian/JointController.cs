...
namespace InverseKinematics
{
    public class JointController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            dim[0] = new Vector3(-0.137984902f, -0.052804675f, -0.00203030417f); //Vector3(0f, 0.06584513f, -0.0643453f);
            dim[1] = new Vector3(0.0982258841f, 0.224315047f, 0.00394461071f); // Vector3(-3.109574e-05f, 0.2422461f, -0.005073354f);
            dim[2] = new Vector3(0.0146758426f, 0.212187618f + 0.04468203f, -0.00208123797f + 0.04507105f); // Vector3(3.109574e-05f, 0.1733774f + 0.04468203f, 0.04262526f - 0.04507105f); 
            dim[3] = new Vector3(-0.0391060822f, 0.0552955046f, -0.00264642341f);// Vector3(0f, 0.03749204f, -0.03853976f);
            dim[4] = new Vector3(-0.0386000015f, 0.0164000001f, -0.00340000005f); // Vector3(0f, 0.045f, -0.047f);
